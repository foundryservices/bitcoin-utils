...
class BaseHelper:
    ...
    def get_available_market_open_interest(self):
        ...
        Returns:
            JSON: Available market open interest
        """
        response = requests.get(
    ...
    def get_available_market_liquidations(self):
        ...
        Returns:
            JSON: Available market liquidations
        """
        response = requests.get(
    ...
    def get_available_market_contract_prices(self):
        ...
        Returns:
            JSON: Available market contract prices
        """
        response = requests.get(
    ...
    def get_available_market_funding_rates(self):
        ...
        Returns:
            JSON: Available market funding rates
        """
        response = requests.get(
    ...
    def get_available_market_implied_volatility(self):
        ...
        Returns:
            JSON: Available market implied volatility
        """
        response = requests.get(
    ...
    def get_available_market_orderbooks(self):
        ...
        Returns:
            JSON: Available market orderbooks
        """
        response = requests.get(
    ...
    def get_available_exchange_asset_pairs(self):
        ...
        Returns:
            JSON: Available exchange asset pairs
        """
        response = requests.get(
    ...
    def get_available_exchange_asset_metrics(self):
        ...
        Returns:
            JSON: Available exchange asset metrics
        """
        response = requests.get(
